  ...
  return (  
    <section id="about" className='xs:py-12 xs:px-0 md:pt-20 md:pb-0 lg:w-full lg:pt-24 pr-20'>
      <div className='xs:text-center headings font-bold text-center my-8 '>
        <h5 className='heading2 xs:text-lg md:text-xl lg:text-2xl lg:font-normal'>Know more</h5>
        <h2 className='heading1 xs:text-3xl md:text-4xl lg:text-4xl text-blue-400'>About me</h2>
      </div>
      <div className='about-container'>
        ...
        <div className='about-text xs:text-base xs:text-justify xs:tracking-normal sm:text-lg md:text-xl lg:text-2xl lg:tracking-wider' >
          ...
          <br />
          <p>I recently graduated with a <span className="text-white">BCA</span> degree in 2023 and am currently pursuing my <span className="text-white">MCA</span> through online mode at <span className="text-white">Uttaranchal University, Dehradun</span>. This academic pursuit has provided me with a solid foundation in computer science, which I apply to my development work.</p>
          <br />
