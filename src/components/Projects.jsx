...
const Projects = () => {    
  return (
    <div id='projects' className="xs:py-12 xs:mx-0 md:pt-20 py-20 mr-20">
      ...
      <div className="flex flex-col gap-8 xs:gap-2">
        ...
        <Link to="/all-projects" className="xs:text-sm xs:justify-center sm:text-lg text-slate-400 px-4 capitalize text-lg flex items-center hover:text-blue-100 hover:underline underline-offset-8 gap-2"><span>View all projects</span> <span><FaArrowRight /></span></Link>
      </div>
    </div>
  );
}
