  ...
  return (
    <div id='projects' className="xs:py-12 xs:mx-0 md:pt-20 lg:pt-24 py-20 mr-20">
      ...
      <div className="flex flex-col gap-8 xs:gap-2">
        ...
        <Link to="/all-projects" className="xs:text-xs xs:justify-center sm:text-sm md:text-base md:justify-start lg:my-4 text-slate-400 px-4 capitalize text-lg flex items-center hover:text-blue-100 hover:underline underline-offset-8 gap-2"><span>View all projects</span> <span><FaArrowRight /></span></Link>
      </div>
    </div>
  );
}
