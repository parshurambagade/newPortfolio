...
const HeaderSocials = () => {
  return (
    <div className='header-socials xs:w-9/12 xs:justify-center xs:gap-20 xs:flex-wrap p-4 xs:text-2xl sm:gap-24 sm:w-full md:text-3xl md:gap-28 lg:w-full lg:justify-between  flex gap-28  text-[2rem] '>
