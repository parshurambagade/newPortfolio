...
const HeaderSocials = () => {
  return (
    <div className='header-socials xs:w-9/12 xs:justify-center xs:gap-20 xs:flex-wrap p-4 xs:text-2xl sm:gap-24 sm:w-full md:text-3xl md:gap-28 lg:w-full lg:justify-between lg:pr-12  flex lg:p-0 lg:gap-8 xl:w-[80%] xl:justify-between'>
